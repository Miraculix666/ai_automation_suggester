# AI Rebuild & Architecture Directive: System / config_flow
...
- Component / Script: config_flow.py
- Category: System
...
## Example AI Prompt
```markdown
Please review and rebuild the script config_flow.py in folder System:
